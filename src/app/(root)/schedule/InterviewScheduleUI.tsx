    ...
    <div className="container max-w-7xl mx-auto p-8 space-y-10">
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-lg">Schedule and manage interviews</p>
        </div>
      ...
      {!interviews ? (
        ...
        <div className="text-center py-16 text-muted-foreground text-lg">No interviews scheduled</div>
      )}
    </div>
  );
}
